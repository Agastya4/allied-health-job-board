...
export default function TestLocationsPage() {
  ...
  return (
    <>
      <SEO 
        title="Test Locations - AlliedHealthJobs.au"
        description="Test location filtering and job location updates for the allied health job board."
        keywords={[
          'test locations',
          'location filtering',
          'job location test',
          'allied health jobs test'
        ]}
        url="/test-locations"
        type="website"
      />
