...
export function JobCard({ job, onClick, isSelected, onBookmarkToggle, shiftDown }: JobCardProps) {
  ...
  return (
    <Card
      className={cn(
        "p-4 flex items-start gap-4 cursor-pointer transition-colors relative",
    ...
    >
      <Image
        ...
        width={56}
        height={56}
        className="w-14 h-14 object-cover rounded-lg border border-gray-200 dark:border-zinc-700"
      />
